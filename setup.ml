...
(* OASIS_START *)
(* DO NOT EDIT (digest: 64404b13db01d74a151a576eab3e1873) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/neperien";
            ...
            [
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "build and install the log parser (depends on bencode)";
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "build and install the log reader (depends on containers)";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("bencode", None)];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Neperien_Parse"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "neperien";
                      lib_findlib_name = Some "parse";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "neperien_parse";
                           FindlibPackage ("notty", None);
                           FindlibPackage ("notty.unix", None);
                   ...
                   {exec_custom = false; exec_main_is = "logn.ml"});
               Executable
                 ({
                     cs_name = "cat_neperien";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "src/bin/";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "neperien_parse"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "cat_neperien.ml"});
               Executable
                 ({
                     cs_name = "random_neperien";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "src/bin/";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "neperien"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "random_neperien.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\168\163\130J\176K\254\018\004n\128\128\176\156\195\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
