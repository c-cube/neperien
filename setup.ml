...
(* OASIS_START *)
(* DO NOT EDIT (digest: 638100a48cf5d32da648aa83c4a60b06) *)
(*
...
let setup_t =
  {
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "build and install the log indenter (depends on containers)";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Neperien"; "Neperien_intf"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\134_QEWq\2287s\162\167#\178\145_\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
